...
class QueryForm extends Component<Props, State> {
  state = {
    keyword: '',
    geo: '',
    startMonth: '',
      ...
      <div className="QueryForm">
        <div className="row">
          ...
          <div className="container well col-sm-4 col-sm-offset-4">
            <form className="queryForm" onSubmit={this.handleFormSubmit}>
              ...
              <div className="form-group col-lg-6 startMonth">
              ...
              <div className="form-group col-lg-6 endMonth">
